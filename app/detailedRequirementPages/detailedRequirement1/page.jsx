...
const DetailedRequirement1 = () => {
  ...
  useEffect(() => {
    ...
    const storedAnswers = JSON.parse(sessionStorage.getItem("detailedRequirementAnswers"));
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("detailedRequirementAnswers", JSON.stringify(answers));
    calculateProgress();
  }, [answers]);
  ...
  const calculateProgress = () => {
    ...
    const requiredFields = [
      answers.enginePower,
      answers.batteryCapacity,
      answers.driveModes,
      answers.exteriorDesign.length > 0,
      answers.groundClearance,
      answers.fuelTankCapacityMin,
      answers.fuelTankCapacityMax,
      answers.bootSpaceMin,
      answers.bootSpaceMax,
  ...
  const handleSubmit = async () => {
    const body = {
      ...
      bodyStyle: sessionStorage.getItem("bodyStyle"),
    ...
    try {
      const response = await fetch(
        "/api/detailedRequirementPagesRoutes/detailedRequirement1Route",
        {
          method: "POST",
          headers: {
  ...
  const handleNext = async () => {
    if (currentSection === 4) {
      await handleSubmit();
      router.push("/detailedRequirement2");
    } else {
        ...
        <div className="w-5/6 p-6 bg-white">
          <div className="space-y-8">
            ...
            <div className={`${currentSection === 0 ? "block" : "hidden"}`}>
              {answers.fuelType !== "Electric" ? (
                <>
                  <h2 className="text-lg font-bold mt-8"> How important is car power to you? </h2>
                    ...
                    {[
                      ...
                      <label key={option} className="block">
                        <input
                          ...
                          onChange={() =>
                            handleRadioChange("enginePower", option)
                          }
                          className="mr-2"
                        />
                        {option}
                ...
                <>
                  <h2 className="text-lg font-bold mt-8"> What is your preferred battery capacity? </h2>
                  <p className="text-sm text-gray-500 mb-2"> Note: Electric car prices and driving range increase with greater battery capacity. </p>
                  <select
            ...
            <div className={`${currentSection === 1 ? "block" : "hidden"}`}>
              <h2 className="text-lg font-bold"> Which of the following drive modes are available in the car you are interested in? </h2>
                ...
                {[
                  ...
                  <label key={option} className="block">
                    <input
                      ...
                      onChange={() =>
                        handleRadioChange("driveModes", option)
                      }
                      className="mr-2"
                    />
                    {option}
            ...
            <div className={`${currentSection === 2 ? "block" : "hidden"}`}>
              ...
              <div className="space-y-4">
                ...
                <div className="mb-4">
                  <h1 className="text-lg font-bold"> Ground Clearance Preference </h1>
                  <div className="flex gap-4 flex-wrap">
                    {["High", "Moderate", "Low"].map((option) => (
                      <label key={option} className="block">
                        <input
                          ...
                          onChange={() =>
                            handleRadioChange("groundClearance", option)
                          }
                          className="mr-2"
                        />
                        {option}
            ...
            <div className={`${currentSection === 4 ? "block" : "hidden"}`}>
              ...
              <div className="space-y-12">
                ...
                <div className="mb-4 mt-2">
                  <h1 className="text-lg font-bold">Entertainment Features</h1>
                  <div className="flex gap-4 flex-wrap">
                    {[
                      ...
                      <label key={option} className="block">
                        <input
                          type="checkbox"
                          value={option}
                          checked={answers.entertainmentFeatures.includes(option)}
                          onChange={() =>
                            handleCheckboxChange("entertainmentFeatures", option)
                          }
                          className="mr-2"
                        />
                        {option}
                ...
                <div className="mb-4">
                  <h1 className="text-lg font-bold">Driving Assistance Features</h1>
                  <div className="flex gap-4 flex-wrap">
                    {[
                      "Cruise Control",
                      "Navigation System",
                      ...
                      <label key={option} className="block">
                        <input
                          type="checkbox"
                          value={option}
                          checked={answers.drivingAssistanceFeatures.includes(option)}
                          onChange={() =>
                            handleCheckboxChange("drivingAssistanceFeatures", option)
                          }
                          className="mr-2"
                        />
                        {option}
                    ...
                    {[
                      ...
                      <label key={option} className="block">
                        <input
                          ...
                          onChange={() =>
                            handleRadioChange("drivingExperience", option)
                          }
                          className="mr-2"
                        />
                        {option}
